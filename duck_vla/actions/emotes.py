...
class EmoteController:
    ...
    def _check_sound_files(self) -> None:
        ...
        if missing_categories:
            ...
            logger.info(
                f"Place .wav files in {self.sounds_dir} following the naming convention in the sound_map"
            )
            ...
            if not os.listdir(self.sounds_dir):
                ...
                try:
                    with open(readme_path, "w") as f:
                        ...
                        f.write(
                            "Place .wav files in this directory with the following naming convention:\n\n"
                        )
